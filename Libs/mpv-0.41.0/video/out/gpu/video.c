                           ...
                           const struct ra_fbo *fbo, int flags)
{
    ...
    double total = (t6 - t0) / 1000000.0;
    if (total > 0.1) {
        MP_INFO(p, "[PERF_INTERNAL] Frame:%lld | Total:%.3fms [Opts:%.3f Clear:%.3f PassRender:%.3f DrawScreen:%.3f Wait:%.3f OSD:%.3f]\n",
