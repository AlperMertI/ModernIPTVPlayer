...
namespace ModernIPTVPlayer.Services.Json
{
    ...
    [JsonSerializable(typeof(LiveCategory))]
    [JsonSerializable(typeof(VodStream))]
    [JsonSerializable(typeof(SeriesStream))]
    [JsonSerializable(typeof(TmdbMovieResult))]
    [JsonSerializable(typeof(StremioMediaStream))]
    [JsonSerializable(typeof(List<StremioSubtitle>))]
    [JsonSerializable(typeof(List<StremioStream>))]
    [JsonSerializable(typeof(TmdbPersonInfo))]
    [JsonSerializable(typeof(PersonRoleItem))]
    [JsonSerializable(typeof(PersonFilmographyItem))]
    [JsonSerializable(typeof(XtreamUserInfo))]
    [JsonSerializable(typeof(XtreamServerInfo))]
    [JsonSerializable(typeof(TmdbVideo))]
    [JsonSerializable(typeof(TmdbImages))]
    [JsonSerializable(typeof(TmdbImage))]
    [JsonSerializable(typeof(TmdbCast))]
    [JsonSerializable(typeof(TmdbCrew))]
    [JsonSerializable(typeof(TmdbGenre))]
    [JsonSerializable(typeof(TmdbSeason))]
    [JsonSerializable(typeof(TmdbEpisode))]
    [JsonSerializable(typeof(TmdbExternalIds))]
